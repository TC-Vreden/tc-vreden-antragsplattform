    ...
    sections: [
      ...
      },
      {
        ...
        bullets: [
          ...
          "Einladungs- und Passwortlinks laufen über /auth/confirm und führen danach auf /verwaltung/passwort-neu.",
          "Die Bestätigungsroute prüft den Supabase-Token serverseitig und setzt die Passwort-Sitzung per Cookie, damit keine lokale PKCE-Vorbereitung im Browser nötig ist.",
